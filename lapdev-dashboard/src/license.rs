...
pub fn UpdateLicenseView(update_counter: RwSignal<i32>) -> impl IntoView {
    ...
    view! {
        ...
        <CreationModal title="Update Enterprise License".to_string() modal_hidden body action is_update=true create_button_hidden=false />
    }
}
...
pub fn SignLicenseView() -> impl IntoView {
    ...
    view! {
        ...
        <CreationModal title="Sign Enterprise License".to_string() modal_hidden body action  is_update=false create_button_hidden=false />
    }
}
